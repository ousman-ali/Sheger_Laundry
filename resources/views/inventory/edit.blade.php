    ...
    <div class="py-6">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('inventory.update', $item) }}" method="POST" class="space-y-4">
                    @csrf
                    @method('PUT')
                    <div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="minimum_stock" class="w-full border rounded p-2" value="{{ old('minimum_stock', $item->minimum_stock) }}">
